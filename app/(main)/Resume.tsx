...
import { BriefcaseIcon, SparkleIcon } from '~/assets'
...
export function Resume() {
  const emptyProject = <p className="text-zinc-500 dark:text-zinc-400 flex items-center"><SparkleIcon className='mr-1'/>暂无工作经历，晚点就有啦</p>
